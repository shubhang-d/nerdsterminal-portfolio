  ...
  return (
    <>
      ...
      >
        ...
        {/* 3D world — always rendered as the background */}
        <div className="fixed inset-0 z-0">
          <MindMapWorld currentNodeId={currentNodeId} onNavigate={navigate} />
        </div>

        {/* Node content overlay — fades in after camera arrives */}
        <NodeContent nodeId={currentNodeId} traveling={traveling} />

        {/* HUD — D-pad, minimap, progress */}
        <MindMapHUD
